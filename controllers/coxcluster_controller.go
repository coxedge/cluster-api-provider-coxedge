...
//+kubebuilder:rbac:groups=cluster.capi.pf9.io,resources=coxclusters/finalizers,verbs=update
...
func (r *CoxClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
